...
A second \textit{true} MACC was generated under to abate as many emissions as possible under the assumption that the district heating system could not be abandoned and assuming the worst-case climate scenario. Figure \ref{fig:MACC_true_DH_waterfall} describes how each measure contributes to overall emissions reduction. 
