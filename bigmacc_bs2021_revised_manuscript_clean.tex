...
\title{%
Simulation and visualization framework for selecting appropriate urban-scale % Line 1
climate mitigation and adaptation strategies} % Line 2 
...
\author{%
Justin McCarty$^1$, Adam Rysanek$^1$ % Line 4
\\ 	
$^1$School of Architecture and Landscape Architecture, \\ % Line 5
The University of British Columbia, Vancouver, BC, Canada % Line 6
...
\begin{figure}[t!]
    \centering
    \captionsetup{margin=.5cm}
    \includegraphics[scale=0.40]{figures/pareto_plots_585_box_update.eps}
